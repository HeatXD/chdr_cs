...
namespace CsBindgen
{
    ...
    {
        const string __DllName = "libchdr_cs";

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_open_core_file", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int chd_open_core_file(chd_core_file* file, int mode, _chd_file* parent, _chd_file** chd);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_open_file", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int chd_open_file(_iobuf* file, int mode, _chd_file* parent, _chd_file** chd);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_open", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int chd_open(byte* filename, int mode, _chd_file* parent, _chd_file** chd);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_precache", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int chd_precache(_chd_file* chd);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_close", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void chd_close(_chd_file* chd);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_core_file", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern chd_core_file* chd_core_file(_chd_file* chd);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_error_string", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern byte* chd_error_string(int err);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_get_header", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern _chd_header* chd_get_header(_chd_file* chd);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_read_header", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int chd_read_header(byte* filename, _chd_header* header);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_read", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int chd_read(_chd_file* chd, uint hunknum, void* buffer);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_get_metadata", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        ...
        [DllImport(__DllName, EntryPoint = "csbindgen_chd_codec_config", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int chd_codec_config(_chd_file* chd, int param, void* config);

        [DllImport(__DllName, EntryPoint = "csbindgen_chd_get_codec_name", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
